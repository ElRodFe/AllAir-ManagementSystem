...
ADD CONSTRAINT fk_owner_id FOREIGN KEY (owner_id) REFERENCES public."Clients" (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE CASCADE NOT VALID;
ALTER TABLE IF EXISTS public.work_orders
ADD CONSTRAINT client_id FOREIGN KEY (client_id) REFERENCES public."Clients" (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE CASCADE NOT VALID;
ALTER TABLE IF EXISTS public.work_orders
ADD CONSTRAINT vehicle_id FOREIGN KEY (vehicle_id) REFERENCES public."Vehicles" (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE CASCADE NOT VALID;
END;